      ...
      >
          ...
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            ...
            {project.hasPendingGate && (
              <Badge className="bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-500/30 text-xs animate-pulse">
                ...
                {t('portfolio.hubComponents.pendingPmoApproval')}
              </Badge>
            )}
          </div>
        ...
        <div className="flex items-center gap-6 shrink-0">
          <div className="text-center">
            <p className="text-xs text-muted-foreground">{t('portfolio.hubComponents.progress')}</p>
          ...
          <div className="text-center">
            <p className="text-xs text-muted-foreground">{t('portfolio.hubComponents.team')}</p>
          ...
          <div className="text-center">
            <p className="text-xs text-muted-foreground">{t('portfolio.hubComponents.due')}</p>
