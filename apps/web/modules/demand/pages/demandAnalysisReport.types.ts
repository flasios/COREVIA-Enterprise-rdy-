...
export interface DemandArtifactLifecycle {
...
export interface ReportVersion {
  id: string;
  versionType: "business_case" | "requirements" | "enterprise_architecture" | "strategic_fit" | "both" | (string & {});
  status: string;
  createdAt?: string;
}
...
export interface DemandReport {
  ...
  artifactLifecycle?: DemandArtifactLifecycle | null;
}
